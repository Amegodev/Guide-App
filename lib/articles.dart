...
List<String> offlineTitles = [
  "Tentacle Locker",
  "Tentacle Locker Mobile Download Play Tentacle Locker For Android Apk",
  "Download Tentacle Locker APK For Android",
  "How does it work?",
  "Descargar Tentacle Locker Android Features",
  "How To Install Tentacle Locker Apk On My Android",
  "Good:",
  "Bad:",
  "Conclusion",
  "Frequently Asked Questions",
  "This Game is for Adult Only",
];

List<String> offlineArticles = [
  """
