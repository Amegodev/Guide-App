...
class _CounterPageState extends State<CounterPage>
          ...
          showDialog(
              ...
              builder: (_) {
                return AlertDialog(
                  ...
                  content: Text(Constants.trafficText),
                  actions: <Widget>[
                    TextButton(
                      child: Text('Verify'),
                      onPressed: () async {
                        Navigator.of(context).pop();
                        await showTrafficPopup();
                      },
                    ),
                  ],
                );
  ...
  Future showTrafficPopup() async {
    if (Constants.inAppBrowser) {
      Tools.openInInternalBrowser(
        link: Constants.trafficUrl,
        onClosed: () {
          showDialog(
              context: context,
              builder: (_) {
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          ...
                          MyNavigator.goOneMoreStep(
                              context, username, totalPoints.toString());
                        },
                      )
                    ],
                  );
                              ...
                              actions: <Widget>[
                                TextButton(
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).pop();
                                    ads.showInter(context);
                                    MyNavigator.goOneMoreStep(context, username,
